...
void readCells() {
  ...
  float v = readADS(3);
  float a0 = (readADS(0) - (1.5 * v)) * 2.01;
  float a1 = (readADS(1) - (1.5 * v)) * 2.01;
  float a2 = (readADS(2) - (1.6 * v)) * 3.025;
...
// =====================================================
// RS485: GỬI DỮ LIỆU DẠNG TEXT (THEO CODE MẪU)
// =====================================================
void rs485TextSend()
{
...
void setup() {
  ...
  // Khởi tạo RS485 (UART2: TX=17, RX=16) theo code mẫu
